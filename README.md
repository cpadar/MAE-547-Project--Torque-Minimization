...
This repository contains the code to minimize torque control effort for a 2-link robot that moves from one position to another. Optimization of the torque control effort takes place in the MATLAB code. The MuJoCo simulation provides a visual representation of the robot motion.
...
* Beginning and end joint position input
* Optimization of torque cost
...
* STL units are **mm → scaled to meters** using:

  ```
  scale="0.001 0.001 0.001"
  ```
* Min-jerk ensures smooth start/stop
* Energy optimization reduces torque usage
